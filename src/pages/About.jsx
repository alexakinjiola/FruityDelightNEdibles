...
const pillars = [
  {
    ...
    body: "To be the go-to destination for healthy, mouth-watering fruit drinks and finger foods — tailored to our customers, hygiene never optional.",
  },
  {
    label: "Mission",
...
const timeline = [
  { year: "Year 1", text: "Started in Ede, Osun State with a handful of smoothie and juice flavours." },
  ...
  { year: "Today", text: "Growing steadily into new locations, always with the same hands-on quality in every order." },
];
        ...
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          ...
          <ScrollReveal delay={0.1}>
            ...
            <p className="mt-5 text-ink-soft leading-relaxed">
              What started as a small outlet in Ede, Osun State has grown into a name trusted
              for individual orders, celebrations and corporate bookings across the South-West
